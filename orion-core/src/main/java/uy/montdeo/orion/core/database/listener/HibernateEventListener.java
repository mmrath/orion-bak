package uy.montdeo.orion.core.database.listener;
...
import uy.montdeo.orion.core.AbstractTranslatableEntity;
...
public class HibernateEventListener implements PostLoadEventListener, PreInsertEventListener, PreUpdateEventListener {
	...
	public void onPostLoad(PostLoadEvent event) {
		...
		//Loading translation for the translatable field
		if (entity instanceof AbstractTranslatableEntity) {
			AbstractTranslatableEntity source = (AbstractTranslatableEntity) entity;
			source.setName(messageSource.getMessage("entity.".concat(source.getKey()), null, source.getKey(), getLocale()).toUpperCase(getLocale()));
		}
