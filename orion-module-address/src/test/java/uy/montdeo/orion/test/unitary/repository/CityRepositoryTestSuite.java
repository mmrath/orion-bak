 ...
 * @see CityRepository
 */
public class CityRepositoryTestSuite extends AbstractUnitaryTestSupport {
	...
	public void testFindByStateId_withValidStateId_shouldReturnResults() {
		try {
			...
			List<City> results = cityRepository.findByStateId(ID_000001);
	...
	public void testFindByStateId_withInvalidStateId_shouldReturnEmptyList() {
		try {
			List<City> results = cityRepository.findByStateId(ID_100000);
	...
	public void testFindOne_withValidId_shouldReturnResult() {
		try {
			City existing = cityRepository.findOne(ID_000001);
	...
	public void testFindOne_withInvalidId_shouldThrowException() {
		cityRepository.findOne(ID_100000);
	}
